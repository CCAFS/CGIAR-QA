...
export class CreateTags1612194056087 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `qa_general_configuration` DROP COLUMN `phase_year`", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `qa_general_configuration` ADD `phase_year` int NULL", undefined);
